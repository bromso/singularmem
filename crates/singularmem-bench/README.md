...
| `--question-type <T>` | Only questions of this type; repeatable. |
...
| All questions filtered out by `--limit`/`--question-type` | 1 |
| Unknown mode/model, `k = 0`, or empty `--k` | 2 (clap usage error) |
